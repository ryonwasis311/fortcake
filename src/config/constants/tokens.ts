...
const defineTokens: any = <T extends TokenList>(t: T) => t
...
interface TestnetTokens {
    readonly [key: string]: Token;
}

export const testnetTokens: TestnetTokens = defineTokens({
    wbnb: new Token(
        TESTNET,
