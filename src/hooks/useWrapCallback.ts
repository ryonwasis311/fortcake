...
export default function useWrapCallback(
    ...
    return useMemo(() => {
        ...
        if (inputCurrency === ETHER && currencyEquals(WETH[chainId as keyof typeof WETH], outputCurrency)) {
            return {
        ...
        if (currencyEquals(WETH[chainId as keyof typeof WETH], inputCurrency) && outputCurrency === ETHER) {
            return {
