                ...
                <SectionFlex className="grid">
                    <PageHeader>
                        ...
                        <Heading as="h4" scale="md" override>
                            FORTCAKE is a community driven crypto meme coins platform built on the Binance Smart Chain. The goal is
                            simple; introduce the world to MEME COINS.
                        </Heading>
                        <Box width="100%" mt={20}>
                ...
                <SectionFlex justifyContent="space-between" alignItems="top" className="features">
                    <Features>
                        <RouterLink to="/play">
                            ...
                            <Heading as="h4">MEME</Heading>
                        </RouterLink>
                        <Text>Find Meme coins, Featuring top cryptos all in one place.</Text>
                    </Features>
                    <Features>
                        <RouterLink to="/swap">
            ...
            <Section>
                        ...
                        <Text>
                            <Box>
                                <Text>
                                    ...
                                    (BSC). FORTCAKE is both a platform and currency used as an independent store of value for meme coiners and
                                    enthusiasts alike.
                                </Text>
                            </Box>
                ...
                <SectionFlex className="grid tokenomics reversed">
                    ...
                    <Box>
                        ...
                        <Text>
                            Featuring the top Binance Smartchain (BNB) meme coins. Each meme coin is connected to our built in swap
                            feature, where you can choose any meme token you like and swap with a click of a button. By default each meme coin is
                            sorted and rated algorithmically in real time called the
                            “FORTCAKE Score” All the meme tokens are rated fairly based on Coingecko score, Community score, Liquidity
                            score.
                        </Text>
                    </Box>
                </SectionFlex>
                <SectionFlex className="grid tokenomics">
                    <Box>
                        ...
                        <Text>
                            <Box>
                                <Text>
                                    FORTCAKE&apos;s built in Swap feature, Trade your favorite meme coins, No registration, no problem.
