                                    ...
                                    isValid && (
                                        <RowBetween>
                                            {approvalA !== ApprovalState.APPROVED && (
                                                ...
                                                >
                                                    {approvalA === ApprovalState.PENDING ? (
                                                        <Dots>{t('Enabling %asset%', { asset: currencies[Field.CURRENCY_A]?.symbol as ReactText })}</Dots>
                                                    ) : (
                                                        t('Enable %asset%', { asset: currencies[Field.CURRENCY_A]?.symbol as ReactText })
                                                    )}
                                                </Button>
                                            )}
                                            {approvalB !== ApprovalState.APPROVED && (
                                                ...
                                                >
                                                    {approvalB === ApprovalState.PENDING ? (
                                                        <Dots>{t('Enabling %asset%', { asset: currencies[Field.CURRENCY_B]?.symbol as ReactText })}</Dots>
                                                    ) : (
                                                        t('Enable %asset%', { asset: currencies[Field.CURRENCY_B]?.symbol as ReactText })
                                                    )}
                                                </Button>
                                            )}
                                        </RowBetween>
