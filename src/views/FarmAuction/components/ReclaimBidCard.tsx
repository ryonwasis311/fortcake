...
const ReclaimBidCard: React.FC = () => {
    ...
    const { isApproving, isApproved, isConfirming, handleApprove, handleConfirm } = useApproveConfirmTransaction({
        ...
        onConfirm: () => {
            return callWithGasPrice(farmAuctionContract, 'claimAuction', [reclaimableAuction?.id], null)
        },
        onSuccess: async ({ receipt }) => {
            checkForNextReclaimableAuction()
            toastSuccess(t('Bid reclaimed!'), <ToastDescriptionWithTx txHash={receipt.transactionHash} children={undefined} />)
        },
    })
