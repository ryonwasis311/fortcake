...
const PlaceBidModal: React.FC<PlaceBidModalProps> = ({
    ...
    useEffect(() => {
        if (userNotEnoughCake) {
            ...
            setErrorText(t('First bid must be %initialBidAmount% CAKE or more.', { initialBidAmount: (initialBidAmount ? initialBidAmount : "") }))
    ...
    return (
        <StyledModal title={t('Place a Bid')} onDismiss={onDismiss} headerBackground={theme?.colors.gradients.cardHeader}>
            ...
            <InnerContent>
                ...
                {isFirstBid && (
                    <Text pb="8px" small>
                        {t('First bid must be %initialBidAmount% CAKE or more.', { initialBidAmount: (initialBidAmount ? initialBidAmount : "") })}
                    </Text>
                )}
                <BalanceInput
