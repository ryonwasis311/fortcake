...
import { Auction, Bidder, ConnectedBidder } from '../../config/constants/types'
...
const FarmAuction = () => {
    ...
    const { currentAuction, bidders, connectedBidder, refreshBidders } = useCurrentFarmAuction(account as string)
        ...
        <>
            ...
            <>
                <PageSection
                    ...
                    dividerPosition="top"
                >
                    <NotWhitelistedNotice connectedBidder={connectedBidder as ConnectedBidder} auction={currentAuction as Auction} />
                    <AuctionTimer auction={currentAuction as Auction} />
                    <AuctionContainer flexDirection={['column', null, null, 'row']}>
                        <Flex flex="1" flexDirection="column" width="100%" minWidth="288px">
                            <AuctionDetails
                                auction={currentAuction as Auction}
                                connectedBidder={connectedBidder as ConnectedBidder}
                        ...
                        <AuctionLeaderboard auction={currentAuction as Auction} bidders={bidders as Bidder[]} />
                    </AuctionContainer>
                </PageSection>
                <PageSection
